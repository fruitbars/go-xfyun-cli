...
func runOCR(ctx context.Context, args []string, stdin io.Reader, stdout, stderr io.Writer) error {
	...
	markdownElements := fs.String("markdown-elements", "watermark=0,page_header=0,page_footer=0,page_number=0,graph=0", "markdown element controls")
	sedElements := fs.String("sed-elements", "watermark=0,page_header=0,page_footer=0,page_number=0,graph=0", "SED element controls")
